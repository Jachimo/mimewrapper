...
def main() -> int:
    ...
    parser.add_argument('-s', '--sidecar', type=str, help='Specify metadata sidecar file')
    parser.add_argument('-o', '--output', type=str, nargs='?', help='Specify output file')
    ...
    with open(args.input, 'rb') as inputf:
        msg.add_attachment(inputf)  # TODO may need to open and pass file object?
